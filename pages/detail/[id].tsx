    ...
    return (
        <div className='flex w-full absolute left-0 top-0 bg-white flex-wrap lg:flex-nowrap' >
            <div className='relative flex-2 w-[1000px] lg:w-9/12 flex justify-center items-center bg-blurred-img bg-no-repeat bg-cover bg-center '>
                <div className=' absolute top-6 left-2 leg:left-6 flex gap-6 z-50 '>
                        ...
                        <div>
                            <Link href='/'>
                                <div className='mt-3 flex flex-col gap-2'>
                                    ...
                                    <p className='capitalize text-[14px] font-medium text-primary hidden md:block '>{post.postedBy.userName}</p>
                                </div>
                            </Link>
                        </div>
                    </div>

                    <p className='text-[16px] px-10 text-primary '>{post.caption}</p>
